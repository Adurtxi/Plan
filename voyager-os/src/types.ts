...
export interface ReservationItem {
  id: string; // string-based unique ID, e.g. 'res-123456789'
  type: 'hotel' | 'flight' | 'train' | 'bus' | 'activity' | 'car-rental' | 'other';
  title: string;
  company?: string;
  bookingReference?: string;
  reservationStatus: ReservationStatus;

  // Datetimes for the bounds of this reservation (e.g check-in to check-out, or flight departure to arrival)
  startDatetime?: string;
  endDatetime?: string;

  // Locations (Airports, Hotels, Stations)
  ...
  // Attachments (PDFs, Images of tickets)
...
export interface LocationItem {
  ...
  reservationStatus?: ReservationStatus;
  bookingRef?: string;
  linkedReservationId?: string; // Links this card to a master ReservationItem in LogisticsTab
  isLinkedChild?: boolean;      // True if this card was automatically generated by the Logistics engine
