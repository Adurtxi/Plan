              ...
              <div className="flex items-center gap-2 ml-4">
                {toast.onUndo && (
                  <RAButton
                    ...
                    className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-nature-primary bg-nature-mint/50 hover:bg-nature-mint px-2 py-1 rounded-md"
                    size="sm"
                  >
